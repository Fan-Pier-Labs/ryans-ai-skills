...
- `scripts/find-review-candidates.sh` — deterministic candidate discovery.
  ...
  trust its output. (It is a wrapper holding this skill's defaults over
  `skills/shared/find-pr-candidates.sh`, the sweep every PR skill runs — call
  the wrapper, not the shared script.)
