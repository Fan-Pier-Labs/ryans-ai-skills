...
echo "rules[].type and bypass_actors read, every Q22 row is a lead that needs the file opened"
echo "and the false-positive list worked, and Q23's ambiguous rows (bin/, vendor/, generated code)"
echo "need the same — all four are in references/quality-checklist.md."
