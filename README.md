...
on an audit's findings: [code-quality-audit](skills/code-quality-audit/SKILL.md) reports which
of its 105-rule ESLint baseline is off, and this skill measures those rules and turns the
affordable ones on, one PR at a time.
